 ...
 *
 * IDENTIFICATION
 *	  src/backend/storage/hfs_common.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef HFS_COMMON_H
...
#define HFS_MIN_IOSIZE  4096            /* 4*1024 */
#define HFS_DEFAULT_IOSIZE  4194304     /* 4*1024*1024 */
#define HFS_MAX_IOZIE   134217728       /* 128*1024*1024 */


extern ssize_t hfs_write(int fd, const void *buf, size_t len);
#endif							/* HFS_COMMON_H */