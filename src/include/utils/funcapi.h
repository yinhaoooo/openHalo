...
typedef Datum (*fn_fmgr_security_definer)(FunctionCallInfo fcinfo);



typedef struct FuncMgrExt
{
    fn_fmgr_security_definer             fmgr_security_definer;
} FuncMgrExt;
