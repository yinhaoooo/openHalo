...
typedef enum NodeTag
{
	...
	/* TAGS FOR PARSER ENGINE、PLANNER ENGINE、EXECUTOR ENGINE */
	T_ParserRoutine,             /* in parser/parserapi.h */
	T_PlannerRoutine,			 /* in optimizer/planner_api.h */
	T_ExecutorRoutine, 			 /* in executor/executor_api.h */
	/* merge command */
	T_MergeStmt,
	T_MergeWhenClause,
	T_MergeAction,
...
typedef enum OnConflictAction
{
	...
	ONCONFLICT_REPLACE			/* ON CONFLICT ... DO REPLACE */
