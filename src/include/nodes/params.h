...
typedef void (*ParentFunctionFetchHook) (ParamListInfo params, void **fn_extra);
...
typedef struct ParamListInfoData
{
	...
	ParentFunctionFetchHook parentfunctionFetch;	/* nest function fetch parent function infomation */
