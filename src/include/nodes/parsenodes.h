...
typedef struct SelectStmt
{
	...
	Node	   *onClause;	    /* ON qualification */
...
typedef struct CallStmt
{
    ...
    bool inProc;                /* MySQL: 该函数调用是否发生在过程或函数中 */
...
typedef struct AlterObjectDependsStmt
{
    ...
    ObjectType	refObjectType;		/* OBJECT_FUNCTION, OBJECT_TRIGGER, etc */
	RangeVar   *refRelation;		/* in case a table is involved */
	Node	   *refObject;			/* name of the refobject */
    int deptype;                 /* type of depend */
