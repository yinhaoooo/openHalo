 ...
 *
 * mys_parser.h
 *	  handle aggregates and window functions in mysql parser
 *		Definitions for the "MySQL" parser (flex and bison phases only)
 *
 * 
...
/* MySQL Raw Parser */
extern const ParserRoutine *GetMysParserEngine(void);
