...
extern void standard_transformAggregateCall(ParseState *pstate, Aggref *agg,
								   			List *args, List *aggorder,
								   			bool agg_distinct);
extern Node *standard_transformGroupingFunc(ParseState *pstate, GroupingFunc *g);
extern void standard_transformWindowFuncCall(ParseState *pstate, WindowFunc *wfunc,
											 WindowDef *windef);
