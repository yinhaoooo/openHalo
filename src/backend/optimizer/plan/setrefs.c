...
static Plan *standard_set_plan_refs(PlannerInfo *root, Plan *plan, int rtoffset);
...
/*
 * standard_set_plan_refs: recurse through the Plan nodes of a single subquery level
 */
static Plan *
standard_set_plan_refs(PlannerInfo *root, Plan *plan, int rtoffset)
{
	ListCell   *l;
