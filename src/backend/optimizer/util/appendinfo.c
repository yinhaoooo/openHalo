...
/*
 * standard_add_row_identity_columns
 *
 ...
 */
void
standard_add_row_identity_columns(PlannerInfo *root, Index rtindex,
...
/*
 * standard_distribute_row_identity_vars
 *
 ...
 */
void
standard_distribute_row_identity_vars(PlannerInfo *root)
{
