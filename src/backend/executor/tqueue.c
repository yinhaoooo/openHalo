 ...
 */
static bool
tqueueReceiveSlot(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
 ...
 */
static void
tqueueStartupReceiver(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag)
{
	/* do nothing */
}
