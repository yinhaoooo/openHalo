...
static void sqlfunction_startup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag);
static bool sqlfunction_receive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag);
 ...
 */
static void
sqlfunction_startup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag)
{
	/* no-op */
}
 ...
 */
static bool
sqlfunction_receive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
