 ...
 */
bool
standard_RelationFindReplTupleByIndex(Relation rel, Oid idxoid,
 ...
 */
bool
standard_RelationFindReplTupleSeq(Relation rel, LockTupleMode lockmode,
 ...
 */
void
standard_ExecSimpleRelationInsert(ResultRelInfo *resultRelInfo,
 ...
 */
void
standard_ExecSimpleRelationUpdate(ResultRelInfo *resultRelInfo,
 ...
 */
void
standard_ExecSimpleRelationDelete(ResultRelInfo *resultRelInfo,
						 EState *estate, EPQState *epqstate,
						 TupleTableSlot *searchslot)
{
	bool		skip_tuple = false;
 ...
 */
void
standard_CheckCmdReplicaIdentity(Relation rel, CmdType cmd)
{
 ...
 */
void
standard_CheckSubscriptionRelkind(char relkind, const char *nspname,
						 const char *relname)
{
	/*
