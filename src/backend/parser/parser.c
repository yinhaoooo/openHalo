...
const ParserRoutine *GetStandardParserEngine(void);	/* Get Standard Parser Engine */
...
static List *standard_raw_parser(const char *str, RawParseMode mode);
...
const ParserRoutine *
GetStandardParserEngine(void)
{
	return &standard_parser_engine;
}
