...
make_parsestate(ParseState *parentParseState)
{
	...
	if (parentParseState)
	{
		...
		pstate->p_pre_funccall_hook = parentParseState->p_pre_funccall_hook;
		pstate->p_pre_procedurecall_hook = parentParseState->p_pre_procedurecall_hook;
		pstate->p_ref_hook_state = parentParseState->p_ref_hook_state;
		/* query environment stays in context for the whole parse analysis */
		pstate->p_queryEnv = parentParseState->p_queryEnv;
		pstate->p_hasmergestmt = parentParseState->p_hasmergestmt;
	}

	
    pstate->targettypelist = NULL;
...
/*
 * standard_transformContainerType()
 ...
 */
void
standard_transformContainerType(Oid *containerType, int32 *containerTypmod)
{
	/*
...
/*
 * standard_transformContainerSubscripts()
 ...
 */
SubscriptingRef *
standard_transformContainerSubscripts(ParseState *pstate,
							 Node *containerBase,
							 Oid containerType,
