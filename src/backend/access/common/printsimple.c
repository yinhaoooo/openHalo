 ...
 */
void
printsimple_startup(DestReceiver *self, int operation, TupleDesc tupdesc, CommandTag commandTag)
{
	StringInfoData buf;
	int			i;
 ...
 */
bool
printsimple(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
