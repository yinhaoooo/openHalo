 ...
 */
static void
copy_dest_startup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag)
{
	/* no-op */
}
 ...
 */
static bool
copy_dest_receive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
