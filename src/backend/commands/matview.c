...
static void transientrel_startup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag);
static bool transientrel_receive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag);
 ...
 */
static void
transientrel_startup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag)
{
 ...
 */
static bool
transientrel_receive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
	DR_transientrel *myState = (DR_transientrel *) self;
