 ...
 */
static bool
donothingReceive(TupleTableSlot *slot, DestReceiver *self, CommandTag commandTag)
{
	return true;
}

static void
donothingStartup(DestReceiver *self, int operation, TupleDesc typeinfo, CommandTag commandTag)
{
}
