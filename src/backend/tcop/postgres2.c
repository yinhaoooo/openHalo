...
{
	standard_exec_simple_query(query_string);
}
...
exec_parse_message(const char *query_string, 
				   ...
				   int numParams)
{
	standard_exec_parse_message(query_string, stmt_name, paramTypes, numParams);
}

static void
exec_bind_message(StringInfo input_message)
{
	standard_exec_bind_message(input_message);
}