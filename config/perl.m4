...
if test "$PERL"; then
  ...
  then
    AC_MSG_WARN([
*** The installed version of Perl, $PERL, is too old to use with Halo.
...
if test -z "$PERL"; then
  AC_MSG_WARN([
*** Without Perl you will not be able to build Halo from Git.
*** You can obtain Perl from any CPAN mirror site.
*** (If you are using the official distribution of Halo then you do not
